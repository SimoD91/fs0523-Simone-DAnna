...
if (numero1 > numero2) {
  console.log("Numero maggiore", numero1)
}
...
if (numero3 != 5) {
  console.log("not equal", numero3 != 5)
}
...
if (numero4 % 5 === 0) {
  console.log('divisibile per 5', numero4 % 5)
}
...
let spedizionegratis = 0
let spedizione = 10

if (totalShoppingCart < 50) {
  console.log("Ammontare totale", totalShoppingCart) //Sicuramente sbagliata, ci rinuncio
}
...
let codice = "Buongiorno"
console.log("Non è un numero",typeof codice)
